...
1. **Login Condition Check**<br/>
   ...
   Test Cases:
    ...
    -	Invalid email → fail
      <img width="630" alt="image" src="https://github.com/user-attachments/assets/593bcc93-1035-4d4f-b0a5-2a13bde01a61" />
...
2. **Role-Based Access Logic**<br/>
   ...
   Expected Result: Correct permissions assigned for each role.
     <img width="730" alt="image" src="https://github.com/user-attachments/assets/679cbeb6-9068-4caa-9ac8-e1c744b6cfd6" />
